...
export class CustomerOnServerCreated implements Action {
  ...
  constructor(public payload: { customer: ProjectModel }) {
  }
}
...
export class CustomerUpdated implements Action {
  ...
  constructor(public payload: {
    partialCustomer: Update<ProjectModel>, // For State update
    customer: ProjectModel // For Server update (through service)
  }) {
  }
}
...
export class CustomersPageLoaded implements Action {
  ...
  constructor(public payload: { customers: ProjectModel[], totalCount: number, page: QueryParamsModel }) {
  }
}
